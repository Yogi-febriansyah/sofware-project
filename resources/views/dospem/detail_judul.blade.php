...
<!--  Row 1 -->
        <div class="container-fluid">
          <a href="/dospem/judul" class="btn btn-dark mb-2">Kembali</a>
            <div class="card">
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="border-bottom-0">
                              <div class="d-flex align-items-center gap-2">
                                <form action="/dospem/updatejudul/{{$item->id}}" method="POST">
                                  @csrf
                                  <input type="hidden" name="status" value="terima">
                                  <button type="submit" class="btn btn-outline-warning m-1">Terima</button>
                                </form>
                                <form action="/dospem/updatejudul/{{$item->id}}" method="POST">
                                  @csrf
                                  <input type="hidden" name="status" value="tolak">
                                  <button type="submit" class="btn btn-outline-warning m-1">Tolak</button>
                                </form>
                                
                                <a href="/dospem/revisijudul/{{ $item->id }}" class="btn btn-outline-info m-1" >Revisi</a>
                              </div>
                          </td>
                        </tr> 
                        @endforeach         
